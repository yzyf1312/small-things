...
# 配置载荷
    target_url = "https://i.y.qq.com/qzone-music/fcg-bin/fcg_ucc_getcdinfo_byids_cp.fcg" + "?type=1&json=1&utf8=1&onlysong=0&nosign=1&disstid=" + disstid_data + "&g_tk=5381&loginUin=0&hostUin=0&format=json&inCharset=GB2312&outCharset=utf-8&notice=0&platform=yqq&needNewCode=0"
...
def main(disstid_data, cookie_string):
    ...
    for cdlist_item in fcg_data["cdlist"]:
        ...
        for song_data in songlist_data:
            ...
            purl_data = get_purl_from_musicu_fcg(filename_prefix, song_songmid, cookie_string)
